...
"D:\Arduino\arduino_1.8.3\hardware\tools\avr/bin/avr-gcc" -mmcu=atmega328p -o main.elf tmp\main.o tmp\timer1.o tmp\twi.o tmp\pcf8574.o tmp\pcf8574_display.o tmp\usart_dbg.o -lm -emain
